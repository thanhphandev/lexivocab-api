...
namespace LexiVocab.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260321055951_AddGameSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LexiVocab.Domain.Entities.GlobalGameDeck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LexiVocab.Domain.Entities.UserGameStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LexiVocab.Domain.Entities.UserSetting", b =>
                {
                    ...
                    b.Property<bool>("IsTelegramReminderEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsZaloReminderEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("ZaloBotToken")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LexiVocab.Domain.Entities.UserGameStatistic", b =>
                {
                    b.HasOne("LexiVocab.Domain.Entities.User", "User")
                        .WithOne("UserGameStatistic")
                        .HasForeignKey("LexiVocab.Domain.Entities.UserGameStatistic", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LexiVocab.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("UserGameStatistic");
