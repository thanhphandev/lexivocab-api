...
namespace LexiVocab.UnitTests.Features.Reviews.Commands;
...
public class ReviewCommandsTests
{
    ...
    public async Task Handle_WhenValid_ShouldUpdateVocabSpacedRepetitionAndAddLog()
    {
        ...
        var sm2Result = new SrsCalculationResult(1, 2.6, 1, _fixedNow.AddDays(1));
        ...
        existingVocab.LastReviewedAt.Should().Be(_fixedNow);
